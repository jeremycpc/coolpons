...
$(document).ready(function() {
  ...
  const timerFunction = () => {
    const birthday = new Date(2019, 0, 27);
    ...
    if (pastBirthday) {
      ...
      //else show countdown to her birthday

      var future = birthday.getTime() / 1000;
      // var future = new Date().getTime() / 1000 + 3;
  ...
  const cardFunction = (containerId, canvasId, imageSrc, coolpon) => {
    ...
    image.onload = function() {
      drawImageProp(ctx, image, 0, 0, canvasWidth, canvasHeight, 0.5, 0.5);
  ...
  $('.scratch-card-container').each(function(i) {
    var container = $(this)[0];
    var containerId = container.id;
    var canvasId = container.children[0].id;
